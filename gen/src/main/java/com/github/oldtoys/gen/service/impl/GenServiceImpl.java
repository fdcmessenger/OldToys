...
import com.github.oldtoys.gen.mapper.GenMapper;
 ...
 */
@Service
public class GenServiceImpl //extends BaseServiceImple<TableInfo, String> 
...
//    @PostConstruct
//    public void init() {
//        super.init(TableInfo.class, genMapper);
//    }
    ...
    public void generatorCode(TableInfo table, List<ColumnInfo> columns, ZipOutputStream zip) {
        ...
        table.setClassObjName(StringUtils.uncapitalize(className));
        // 列信息
