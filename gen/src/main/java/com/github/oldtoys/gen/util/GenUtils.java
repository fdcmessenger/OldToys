package com.github.oldtoys.gen.util;
...
import com.github.oldtoys.gen.config.GenConfig;
import com.github.oldtoys.gen.domain.ColumnInfo;
...
public class GenUtils {
    ...
    public static List<ColumnInfo> transColums(List<ColumnInfo> columns) {
        ...
        for (ColumnInfo column : columns) {
            // 列名转换成Java属性名
            String attrName = StringUtils.toCamelCase(column.getColumnName());
    ...
    public static VelocityContext getVelocityContext(TableInfo table) {
        ...
        velocityContext.put("classname", table.getClassObjName());
        ...
        velocityContext.put("datetime", DateUtils.formatISO(new Date()));
...
//        templates.add("vm/html/edit.html.vm");
    ...
    public static String getFileName(String template, TableInfo table, String moduleName) {
        // 小写类名
        String classname = table.getClassObjName();
        // 大写类名
