 ...
 * reserved.
 */
package com.github.fdc.generator.util;

import com.gitee.fdc.kits.DateUtil;
import com.gitee.fdc.kits.FileUtils;
import com.gitee.fdc.kits.FreeMarkers;
import com.gitee.fdc.kits.JaxbMapper;
...
import com.github.fdc.generator.entity.GenCategory;
...
//import org.sbbs.urpm.entity.Area;
//import org.sbbs.urpm.entity.Office;
//import org.sbbs.urpm.entity.User;
...
public class GenUtils {
    ...
    public static void initColumnField(GenTable genTable) {
        for (GenTableColumn column : genTable.getColumnList()) {
            ...
            } else if (StringUtils.startsWithIgnoreCase(column.getJdbcType(), "INT") || StringUtils.startsWithIgnoreCase(column.getJdbcType(), "INTEGER")) {
...
//                }
            ...
            // 是否是主键
            column.setIsPk(genTable.getPkList().contains(column.getName()) ? true : false);
...
//            } // 创建时间、更新时间
    ...
    public static Map<String, Object> getDataModel(GenScheme genScheme) {
        ...
        model.put("lastPackageName", StringUtils.replace((String) model.get("packageName"), ".", "/"));
        model.put("lastPackageNameAsViewPath", StringUtils.substringAfterLast((String) model.get("packageName"), "."));
        ...
        model.put("functionAuthor",
                StringUtils.isNotBlank(genScheme.getFunctionAuthor()) ? genScheme.getFunctionAuthor() : "sysGen");
...
//	model.put("dbType", Global.getConfig("jdbc.type"));
    ...
    public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile) {
        // 获取生成文件
        String fileName = getProjectPath()
                + File.separator
